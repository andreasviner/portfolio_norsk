...
def pattern(screen,color_1,color_2,screen_width,screen_hight,first_a,arrow_size,i,white):
    ...
    if white == 0:
        ...
        all_sprites_list.update()
        off_x = (first_a.image.get_width() - arrow_size)/2 +20
        off_y = (first_a.image.get_height()- arrow_size)/2 +20
        ...
        all_sprites_list.update()
        off_x = (first_a.image.get_width() - arrow_size)/2 +arrow_size/2 +20
        off_y = (first_a.image.get_height()- arrow_size)/2 +arrow_size/2 +20
