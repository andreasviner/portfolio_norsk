...
player_coins = 0
standard_player_speed = 3
standard_player_size = 50



arrows_data = []
lines_arr = [(50,50,100,100)]
arrows_rects =[]
unlocked_arr = []
screen_x = 0
...
inited = loading_screen.init(100)
pygame.init()
...
stone = sprites.stone_s((unlocked_size//2)*squ_size,(unlocked_size//2)*squ_size)
...
##                                    update_bar_rect()
    ...
    if attacking:
        ...
        if sword_active:
            sword.bilt(screen,player.rect.x+standard_player_size//2,player.rect.y+standard_player_size//2,v2,0)
        else:
            pick.bilt(screen,player.rect.x+standard_player_size//2,player.rect.y+standard_player_size//2,v2,0)
    ...
    if shop.rect.collidepoint((player.rect.x+standard_player_size//2,player.rect.y+standard_player_size//2)):
        ...
        pygame.draw.rect(screen, (200,100,100), pygame.Rect(shop.rect.x-30, shop.rect.y+10, 120, 100),0,10)
        pygame.draw.rect(screen, (100,50,50), pygame.Rect(shop.rect.x-30, shop.rect.y+10, 120, 100),5,10)
        
        welcom_text = shop_font.render('2000 coins:', True, (0,0,0))
        ...
        welcom_text = shop_font.render('2000 coins:', True, (255,242,0))
        screen.blit(welcom_text, (shop.rect.x-36, shop.rect.y-15))

        pygame.draw.rect(screen, (200,100,100), pygame.Rect(shop.rect.x-30, shop.rect.y+140, 120, 100),0,10)
        ...
        pygame.draw.rect(screen, (200,100,100), pygame.Rect(shop.rect.x+110, shop.rect.y+10, 120, 100),0,10)
        ...
        pygame.draw.rect(screen, (200,100,100), pygame.Rect(shop.rect.x+110, shop.rect.y+140, 120, 100),0,10)
